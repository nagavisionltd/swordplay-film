...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SWORDPLAY — Official Site" },
      { property: "og:description", content: "A tense London crime drama from director Femi Wilhelm. Streaming June 19, 2026." },
